 ...
 */
@ApiModel(description = "The response structure for errors.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Status {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The error message returned by the server.")
